 ...
 *
 */
public class ReservationConfirmedEventHandler extends
    AbstractQueryEventHandler<ReservationConfirmedEvent> {
   ...
   */
  @Override
  protected Class<ReservationConfirmedEvent> getEventClass() {
   ...
   */
  protected void handleEvent(ReservationConfirmedEvent event) {
