 ...
 */
package org.lhind.reservation_mgmt.query.FlightSearchProjection.dao;
...
public interface QueryFlightDAO {
  ...
  List<QueryFlight> findAll();

  QueryFlight findById(FlightId flightId);

  void insertFlight(QueryFlight flight);

  void updateFlight(QueryFlight flight);

  void deleteFlight(QueryFlight flight);

  List<QueryFlight> findByRouteAndDate(Route route, LocalDate date);
}
