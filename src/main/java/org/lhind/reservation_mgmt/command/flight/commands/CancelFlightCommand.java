...
/**
 * Cancel the entire flight. This should only happen in extreme circumstances
 */
public class CancelFlightCommand extends AbstractCommand {
  private final FlightId flightId;

  public CancelFlightCommand(FlightId flightId) {
    super();
