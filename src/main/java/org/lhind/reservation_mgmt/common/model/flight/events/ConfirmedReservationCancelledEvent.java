...
/**
 * A confirmed reservation for a flight has been cancelled
 *
 */
public class ConfirmedReservationCancelledEvent extends
  ...
  public static final EventType EVENT_TYPE = new EventType(
      "ConfirmedReservationCancelledEvent");

  public ConfirmedReservationCancelledEvent(FlightId flightId,
