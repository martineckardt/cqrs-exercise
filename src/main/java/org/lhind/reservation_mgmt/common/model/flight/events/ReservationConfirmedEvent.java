...
/**
 * A reservation for a flight has been confirmed
 *
 */
public class ReservationConfirmedEvent extends AbstractDomainEvent<FlightId> {
  ...
  public ReservationConfirmedEvent(FlightId flightId, PassengerId passengerId) {
